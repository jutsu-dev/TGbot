...
if not BOT_TOKEN:
    raise SystemExit("❌ BOT_TOKEN не задан в Render Environment.")

HOSTNAME = os.getenv("RENDER_EXTERNAL_HOSTNAME")
if not HOSTNAME:
    raise SystemExit("❌ RENDER_EXTERNAL_HOSTNAME не найден в Render Environment.")
...
OWNER_ID = int(os.getenv("OWNER_ID", "0"))  # айди админа
...
async def cmd_start(message: Message):
    ...
    await message.answer(
        f"✅ Привет! Твой баланс: {u['balance']} Gold\n\n"
        f"Команды:\n/withdraw — вывести\n/admin — админка"
    )
